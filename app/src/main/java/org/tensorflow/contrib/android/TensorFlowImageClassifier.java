...
public class TensorFlowImageClassifier implements Classifier
{
  ...
  private static final String TAG = "TensorFlowImageClss";
  ...
  public static Classifier create(
    ...
    // Read the label names into memory.
	  c.labels.addAll(helper.getLabels());
    ...
    final int status = c.inferenceInterface.initializeTensorFlow(manager, helper.getModelFile().getAbsolutePath());
    if (status != 0) {
